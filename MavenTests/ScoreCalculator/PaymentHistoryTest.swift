...
final class PaymentHistoryTests: XCTestCase {
    ...
    func testNilPaymentHistoryReturnsNeutralScore() {
        let score = calculatePaymentHisotry(paymentHistory: nil)
    ...
    func testNilOnTimeAndMissedPaymentsReturnsNeutralScore() {
        ...
        let score = calculatePaymentHisotry(paymentHistory: paymentHistory)
        XCTAssertEqual(score, 100)
    }
    ...
    func testTwoOrThreeMissedAndSomeOnTimeReturns80() {
        ...
        XCTAssertEqual(calculatePaymentHisotry(paymentHistory: paymentHistory2), 80)
        XCTAssertEqual(calculatePaymentHisotry(paymentHistory: paymentHistory3), 80)
    }
